  ...
  return (
    <main className="flex flex-col items-center">
      ...
      <div>
        ...
        {shop.ascenseur && <div className=" flex justify-center items-center rounded-md p-1 text-primary-color bg-bg-pink font-semibold m-2 shadow-box gap-1  w-[15rem]"><img src={vieux} alt="Old People Friendly" /><p>Difficulté a marché</p></div>}
